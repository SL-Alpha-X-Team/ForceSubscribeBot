...
async def settings(bot: Client, msg):
    ...
    await msg.reply(
        "⚙️ **Settings** \n\n"
        "⚡ Choose action type for those who haven't joined the force subscribe chat. Defaults to Mute.\n"
        "⚡ Choose to ignore welcome messages or not. If you don't want the bot to take action on users just when they join (didn't chat), choose On else Off. Defaults to On.\n"
        "⚡ Choose to allow admins to change fsub chat and settings or not. Defaults to 'Allow Only Owner'.",
